Public MustInherit Class FrmPreDO
...
keluar:
    ...
    Private Sub DTpo_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles DTpo.KeyPress
        Dim KeyAscii As Integer = Asc(e.KeyChar)
        Select Case KeyAscii
            Case Asc("A") To Asc("Z"), Asc("a") To Asc("z")
        End Select
    ...
    Private Sub DTpo_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles DTpo.KeyUp
        If DTpo.Text = "" Then
...
Public Class InputPreDOSuper
    Inherits FrmPreDO

    Private Sub InputPreDOSuper_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Text = "Input Pre DO Supermarket"
        _Toolbar1_Button4.Visible = False
        _Toolbar1_Button5.Visible = False
    End Sub
End Class

Public Class InputPreDODistributor
    Inherits FrmPreDO

    Private Sub InputPreDOSuper_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Text = "Input Pre DO Distributor"
        _Toolbar1_Button4.Visible = False
        _Toolbar1_Button5.Visible = False
    End Sub
End Class

Public Class InputPreDOLain
    Inherits FrmPreDO

    Private Sub InputPreDOSuper_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Text = "Input Pre DO Lain - lain"
        _Toolbar1_Button4.Visible = False
        _Toolbar1_Button5.Visible = False
    End Sub
End Class