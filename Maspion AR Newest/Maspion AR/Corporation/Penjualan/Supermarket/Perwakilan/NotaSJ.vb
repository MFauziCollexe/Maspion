...
Public Class EditNotaSJSupermarketPerwakilan
    ...
    Private Sub EditDeliveryOrderSupermarketPusat_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        HakForm("Penjualan Supermarket", "Perwakilan", "Nota / Surat Jalan", _Toolbar1_Button4, _Toolbar1_Button5, _Toolbar1_Button6)
    End Sub
End Class