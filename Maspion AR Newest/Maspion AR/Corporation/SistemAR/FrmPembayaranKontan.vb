...
Public MustInherit Class FrmPembayaranKontan
    ...
    Private Sub FrmPembayaranKontan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub TxtNota_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles TxtNoDO.ButtonClick
    ...
    Sub hitung()
        ...
        End If
    End Sub
    Private Sub TxtNota_EditValueChanged(sender As Object, e As EventArgs) Handles TxtNoDO.EditValueChanged
    ...
    End Sub
End Class
Public Class InputPembayaranKontan
    Inherits FrmPembayaranKontan
...
Public Class EditPembayaranKontan
    Inherits FrmPembayaranKontan
